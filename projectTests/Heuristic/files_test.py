...
juliet_res_dir = project_source_dir + "/AnalyzerOutputs/juliet_output_files.svres"
svace_res_dir = project_source_dir + "/AnalyzerOutputs/svace_output_files.svres"
...
lines_heuristic = Heuristic(heuristic_name="files", heuristic_params={})
