...
from projectLib.Common import srch_ind, save_list, load_list, print_list, juliet_shorten, remove_parent_dirs
...
class Info:
    ...
    def save_info(self, path):
        save_list(self.info, path)
        return 0

    def load_info(self, path):
        self.info = load_list(path)
        return 0
